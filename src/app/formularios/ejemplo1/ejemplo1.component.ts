...
sumarNumeros():void{
  ...
  const numero3=this.formulario.get('numero2')?.value;
  const numero4=this.formulario.get('numero2')?.value;
  this.resultado= Math.sqrt((numero1 - numero2)**2 + (numero3 - numero4)**2)
